...
_G.packer_plugins = {
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/home/axel/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/axel/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/axel/.local/share/nvim/site/pack/packer/start/typescript.nvim",
